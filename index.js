...
class HtmlWebpackInlineSourcePlugin {
  ...
  apply (compiler) {
    ...
    compiler.hooks.compilation.tap('html-webpack-inline-source-plugin', compilation => {
      HtmlWebpackPlugin.getHooks(compilation).alterAssetTagGroups.tapAsync('html-webpack-inline-source-plugin', (htmlPluginData, callback) => {
  ...
  processTag (compilation, regex, tag, filename) {
    var assetUrl;
